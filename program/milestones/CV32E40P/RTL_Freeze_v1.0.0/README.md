...
### IP Revision
These checklists refer to the first release of the CV32E40P. The GitHub URL for the CV32E40P is https://github.com/openhwgroup/cv32e40p and the GitHub tag for this release is cv32e40p_v1.0.0. Software running on this core can unambiguously identify this core by reading these values from the following CSRs:
- marchid   = 0x4
- mvendorid = 0x602
- mimpid    = 0x0
