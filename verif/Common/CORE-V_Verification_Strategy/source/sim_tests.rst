...
|                          | MMADDR_DBG            | pulse or a level change, with a programable start delay and    |
...
|                          | MMADDR_RNDNUM         | simulator's random number generator.                           |
|                          |                       | Writes have no effect.                                         |
+--------------------------+-----------------------+----------------------------------------------------------------+
| Cycle Counter Control    | 32'h1500_1004         | Writes willl clear the cycle count.                            |
| and Access               | MMADDR_TICKS          |                                                                |
|                          |                       | Reads return current value of the cycle count.                 |
|                          |                       |                                                                |
|                          |                       | **Note**: cycle counter runs automatically and is freerunning  |
+--------------------------+-----------------------+----------------------------------------------------------------+
| Virtual Peripheral       | 32’h2000_0000         | Assert test_passed if wdata==’d123456789                       |
| Status Flags             | MMADDR_TESTSTATUS     |                                                                |
...
|                          | MMADDR_EXIT           |                                                                |
|                          |                       | Assert exit_value (write data)                                 |
|                          |                       |                                                                |
|                          |                       | **Note**: asserted for one clock cycle only.                   |
+--------------------------+-----------------------+----------------------------------------------------------------+
...
|                          | MMADDR_SIGDUMP        | to the signature file.                                         |
|                          |                       |                                                                |
...
| Interface Stall Control  | MMADDR_RNDSTALL       | (depreciated feature)                                          |
+--------------------------+-----------------------+----------------------------------------------------------------+
