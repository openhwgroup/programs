...
- Only a single configuration of the core (RV32EMC) is now included in the verification plan, and other configurations are deferred. 
- The verification approach now uses Spike as a reference model, and the creation of that model is part of this project.  
...
as part of the CORE-V family of cores
  ...
  The 2021 scope of the project included of detailing which of the Ibex parameters are being removed, or verified, or neither verified or removed (left for future work). This has been largely completed as of 2024
...
- RTL design of the Core starting from Ibex with the following features:
 ...
 - CV32E40P-like interrupt interface (Open Titan CLIC) (As of 2024 this is removed)
...
The core configurably supports the RV32{E,I}MC instruction set but as saidabove, only the EMC instruction set is being verified.

The Tristan Project is motivating the completion of this work in 2024. (Link to Statement of Work to be added).
...
Detailed features are available at https://docs.openhwgroup.org/projects/cve2-user-manual/en/latest/01_specification/index.html

Note however, that the core complex (coreplex) is no longer part of the CV32E20 feature deliverables. 
...
| --------------------    		| --------------------    			| -------------------- 					|
| OpenHW Staff	    			| Mario Rodriguez					|	Spike, RTL, verification								|
...
The work breakdown structure at P.A. is listed in the "task list" tab of the spreadsheet https://docs.google.com/spreadsheets/d/1L4QS830qSwUS_B30AWsCoOTGSXbFLExG/edit#gid=141038687
(This spreadsheet should be moved to the programs repo).
...
Note
- table shows target date for completion of high level deliverables
...
| ImperasDV ISA Functional Coverage Model Integration | Completed				|				|				|				|
...
- The Project Board already established https://github.com/orgs/openhwgroup/projects/5/views/1will be updated to include the high level milestones here as well as detailed task list created in the planning spreadsheet
...
Proposed regular project meeting every week at Thursday 8:00 Pacific / 11:00 Eastern Time/ 17:00 Central Europe 
...
| Feature list available		| Y					  				|	User Manual should be tidied up for CV32E20 config features									|
