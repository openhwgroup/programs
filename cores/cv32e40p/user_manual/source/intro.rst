...
The CV32E40P core has been taped-out in several nodes (from 130nm to 22nm)
and tested on silicon many times.

The ``constraints/cv32e40p_core.sdc`` file provides an example of synthesis
constraints.
